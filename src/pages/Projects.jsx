  ...
  return (
    <Flex id="projects" flexDir="column" w="100%" mt="6em">
      ...
      <Flex flexDir="column" alignItems="center" justifyContent="center" overflow="hidden">
        <Project animation="fade-right" image="https://i.ibb.co/rmJGNVF/Screenshot-64.png" name="Code SensAI" description="Leetcode inspired web application that simulates real-time technical interviews by presenting users with coding
challenges and tracking their time to replicate an authentic interview experience." link="https://codesensai.study/"/>
        <Project animation="fade-left" image="https://i.ibb.co/9HG5S7t/Screenshot-32.png" name="Stack Hacks Website" description="The web application built for the Stack Hacks hackathon. It contains infortmation about the event, judges, and how to sign up. It was built using the React framework." link="https://stack-hacks.web.app/"/>
