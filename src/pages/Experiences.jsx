  ...
  return (
    <Flex id="experiences" flexDir="column" w="100%" mt="6em">
      ...
      <Flex flexDir="column" alignItems="center" justifyContent="center" overflow="hidden">
        <Job animation="fade-left" logo="https://media.licdn.com/dms/image/C4E0BAQHYUY5jCzQ7sw/company-logo_100_100/0/1649272031853?e=1731542400&v=beta&t=Y05JcrMVLCnglTwcDTt-Lid44SYpQz_7jKrlEbeSPeg" name="Al Bassem Org" time="Nov 2023 - Apr 2024" job="Software Developer Intern" location="Oakville, ON" points={["Designed and implemented a comprehensive inventory management system using JavaScript, React Native, AWS, and MongoDB ensuring accurate alignment of items with their real-life locations.", "Developed a dynamic React-based mobile application, enabling seamless user account creation and efficient item sign-in/out through QR code scanning."]}/>
        <Job animation="fade-right" logo="https://media.licdn.com/dms/image/v2/D560BAQH9hPeLqgshRQ/company-logo_100_100/company-logo_100_100/0/1706975923430/stack_hacks_logo?e=1731542400&v=beta&t=M2CbWlnlDEBttOoWvQAXO717CiYgs51jwqJCI7Abys4" name="Stack Hacks" time="Feb 2024" job="Co-Founder" location="Remote" points={["Co-Founded Stack Hacks", "Designed, developed, and deployed the website using the ReactJS framework and Firebase", "Managed social media and digital advertising resulting in over 40 signups", "Facilitated event logistics and operations including reaching out and communicating with potential guest speakers"]}/>
